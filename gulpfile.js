...
gulp.task('build', gulp.series(gulp.parallel(pre_build, 'removedist', "imagemin"), "make:css", gulp.parallel('build:css', "build:fonts", "build:files", "build:html"), 'build:images'));
...
gulp.task("finish:him", gulp.series(pre_build, "make:css", "min:css", gulp.parallel("deploy:css")));
